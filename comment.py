...
english_stopwords = {
    ...
    'by', 'from', 'but', 'not', 'or', 'so', 'what', 'can', 'just', 'will', 'about','song',
    'like', 'more', 'than', 'if', 'when', 'where', 'who', 'which', 'how', 'there', 'here', 'all', 'some', 'any', 'no', 'yes',
    'very', 'much', 'many', 'few', 'more', 'most','Im'
}
japanese_stopwords = [
    'これ', 'それ', 'あれ', 'どれ', 'ここ', 'そこ', 'あそこ', 'こちら', 'どこ',
    'わたし', 'あなた', 'かれ', 'かのじょ', 'わたしたち', 'みんな','この', 'その', 'あの', 'どの',
    '何', 'どのように', 'どうして', 'いつ', 'どう', 'なぜ', 'どれくらい', 'どのくらい',
    'どのような', 'どんな', 'どちら', 'どっち',
